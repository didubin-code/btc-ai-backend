...
function healthPayload(){
  return { ok:true, service:'btc-ai-copilot-backend', version:VERSION, endpoints:['/health','/brti','/market','/analyze','/api/ai-review'], settlement_source:'CF_BRTI_PUBLIC_PAGE_PLUS_METHOD_REPLICA', model:OPENAI_MODEL, openai_configured:!!OPENAI_API_KEY, server_ts:new Date().toISOString() };
}
function median(arr){
